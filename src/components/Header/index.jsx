...
function index(props) {
      ...
      children: (
        <>
          ...
          >
            ...
            <Form.Item label="Số điên thoại" name="phone" rules={[{required: true, message: 'Please input your tên!'}]}>
              <Input />
            </Form.Item>
      ...
      label: `Đổi mật khẩu`,
        ...
        <>
          ...
          >
            ...
            <Form.Item label="Mật khẩu mới" name="newpass" rules={[{required: true, message: 'Please input your Mật khẩu mới!'}]}>
               <Input.Password  />
            </Form.Item>
  ...
  return (
    <div className="header-container">
      ...
      <Drawer title="menu chức năng" placement="left" open={openDrawer} onClose={() => setOpenDrawer(false)}>
