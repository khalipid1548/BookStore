...
const Home = () => {
	...
	return (
		<div style={{background: '#e8e8e8', padding: '24px 54px'}}>
			<div className='homepage-container' >
				<Spin spinning={isLoading} tip='Loading...'>
					<Row gutter={[20, 20]}  >
						<Col style={{background: '#fff', padding: 20,paddingTop: 12}} md={4} sm={0} xs={0}>
						...
						<Col style={{background: '#fff',}} md={20} xs={24}>
							...
							<Row style={{display: 'flex', justifyContent: 'center'}}>
								<Pagination
									onChange={(p, s) =>
										hanldePaginationChange({current: p, pageSize: s})
									}
									defaultCurrent={6}
									current={current}
									pageSize={pageSize}
